...
const authRegisterImports: Record<AuthType, () => Promise<any>> = {
    firebase: () => import('./pages/authentication/firebase/AuthRegister'),
    jwt: () => import('./pages/authentication/jwt/AuthRegister'),
    aws: () => import('./pages/authentication/aws/AuthRegister'),
    auth0: () => import('./pages/authentication/auth0/AuthRegister'),
    supabase: () => import('./pages/authentication/supabase/AuthRegister')
};
